        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <img alt="Sapphire Training Solutions" src="/sapphire-training-spark/lovable-uploads/245fc19e-d8e5-4cf8-a193-5dad745d1a4a.png" className="h-20 w-20 filter brightness-0 invert" />
              <div>
