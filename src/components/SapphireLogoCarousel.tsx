...
const clientLogos = [
  { id: 1, name: "Adani Group", src: "/sapphire-training-spark/Logos/Adani_Group_logo.png" },
  { id: 2, name: "Alliance Airlines", src: "/sapphire-training-spark/Logos/Alliance_Airlines_logo.png" },
  { id: 3, name: "Bata", src: "/sapphire-training-spark/Logos/Bata_logo.png" },
  { id: 4, name: "BBJ Construction", src: "/sapphire-training-spark/Logos/BBJ_Construction_logo.png" },
  { id: 5, name: "BHEL", src: "/sapphire-training-spark/Logos/BHEL_logo.png" },
  { id: 6, name: "Blossom Kochhar", src: "/sapphire-training-spark/Logos/Blossom_Kochhar_logo.jpg" },
  { id: 7, name: "Border Roads Organisation", src: "/sapphire-training-spark/Logos/Border_Roads_Organisation_BRO_logo.png" },
  { id: 8, name: "Cafe Coffee Day", src: "/sapphire-training-spark/Logos/Cafe_Coffee_Day_logo.png" },
  { id: 9, name: "Citibank", src: "/sapphire-training-spark/Logos/Citibank_logo.png" },
  { id: 10, name: "Club One Air", src: "/sapphire-training-spark/Logos/Club_One_Air_logo.png" },
  { id: 11, name: "DVC Damodar Valley Corporation", src: "/sapphire-training-spark/Logos/DVC_Damodar_Valley_Corporation_logo.png" },
  { id: 12, name: "EY Ernst Young", src: "/sapphire-training-spark/Logos/EY_Ernst_Young_logo.png" },
  { id: 13, name: "Flipkart", src: "/sapphire-training-spark/Logos/Flipkart_logo.svg" },
  { id: 14, name: "Frankfinn Institute", src: "/sapphire-training-spark/Logos/Frankfinn_Institute_logo.png" },
  { id: 15, name: "GPI Great Plains", src: "/sapphire-training-spark/Logos/GPI_Great_Plains_Industries_logo.png" },
  { id: 16, name: "Jackson", src: "/sapphire-training-spark/Logos/Jackson_logo.svg" },
  { id: 17, name: "KFC", src: "/sapphire-training-spark/Logos/KFC_logo.png" },
  { id: 18, name: "Maruti Suzuki", src: "/sapphire-training-spark/Logos/Maruti_Suzuki_logo.png" },
  { id: 19, name: "NBCC", src: "/sapphire-training-spark/Logos/NBCC_logo.png" },
  { id: 20, name: "NFL National Fertilizers", src: "/sapphire-training-spark/Logos/NFL_National_Fertilizers_logo.png" },
  { id: 21, name: "NHPC", src: "/sapphire-training-spark/Logos/NHPC_logo.png" },
  { id: 22, name: "NIIT", src: "/sapphire-training-spark/Logos/NIIT_logo.svg" },
  { id: 23, name: "Pizza Hut", src: "/sapphire-training-spark/Logos/Pizza_Hut_logo.svg" },
  { id: 24, name: "Prasar Bharati", src: "/sapphire-training-spark/Logos/Prasar_Bharati_logo.png" },
  { id: 25, name: "Samsung", src: "/sapphire-training-spark/Logos/Samsung_logo.png" },
  { id: 26, name: "Sterlite Technologies", src: "/sapphire-training-spark/Logos/Sterlite_Technologies_logo.png" },
  { id: 27, name: "THDC India Limited", src: "/sapphire-training-spark/Logos/THDC_India_Limited_logo.png" },
  { id: 28, name: "UEI Global", src: "/sapphire-training-spark/Logos/UEI_Global_logo.png" },
  { id: 29, name: "Woodward", src: "/sapphire-training-spark/Logos/Woodward_logo.png" },
  { id: 30, name: "Eureka Forbes", src: "/sapphire-training-spark/Logos/Eureka-Forbes-logo.png" },
  { id: 31, name: "MDLR Airlines", src: "/sapphire-training-spark/Logos/mdlr-airlines-logo.png" }
];
