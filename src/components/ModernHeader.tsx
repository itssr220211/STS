...
import { useNavThemeDetector } from '@/hooks/useNavThemeDetector';
...
const ModernHeader: React.FC<ModernHeaderProps> = ({ lenis }) => {
  ...
  const navTheme = useNavThemeDetector(navRef, lenis);
            ...
            <div className="flex items-center px-6 py-3 space-x-6">
              <button onClick={() => scrollToSection('home')} className="flex items-center">
                <img
                  ...
                  src="/sapphire-training-spark/lovable-uploads/dc785b32-7742-48f3-a331-ceb7e7f5a270.png"
              ...
              <div className="hidden lg:flex items-center space-x-4">
                {['Clients', 'About', 'Solutions', 'Industries', 'Testimonials'].map(item => (
                  <button
                    ...
                    className={cn(
                      "text-sm font-medium transition-all duration-300 hover:scale-105 px-4 py-2 rounded-full",
                      navTheme === 'dark'
                        ? "text-white hover:bg-white/20 hover:glow-text"
                ...
                <Button
                  ...
                  className={cn(
                    "px-6 py-2 rounded-full font-semibold transition-all duration-300 hover:scale-105",
                    navTheme === 'dark'
                      ? 'bg-white hover:bg-gray-200 text-gray-900 hover:glow-button'
